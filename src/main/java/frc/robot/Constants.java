...
public final class Constants {
  ...
  public static class Swerve {
    ...
    public static final class Mod0 {
        ...
        public static final Rotation2d ANGLE_OFFSET = Rotation2d.fromDegrees(NTpreferences.getAngleOffset(Module.u0));
    ...
    public static final class Mod1 {
        ...
        public static final Rotation2d ANGLE_OFFSET = Rotation2d.fromDegrees(NTpreferences.getAngleOffset(Module.u1));
        public static final SwerveModuleConstants CONSTANTS = 
            new SwerveModuleConstants(DRIVE_MOTOR_ID, ANLGE_MOTOR_ID, CANCODER_ID, ANGLE_OFFSET);
    }
    public static final class Mod2 {
        public static final int DRIVE_MOTOR_ID = 7;
        public static final int ANGLE_MOTOR_ID = 8;
        public static final int CANCODER_ID = 24;
        public static final Rotation2d ANGLE_OFFSET = Rotation2d.fromDegrees(NTpreferences.getAngleOffset(Module.u2));
        public static final SwerveModuleConstants CONSTANTS = 
            new SwerveModuleConstants(DRIVE_MOTOR_ID, ANGLE_MOTOR_ID, CANCODER_ID, ANGLE_OFFSET);
    }
    ...
    public static final class Mod3 {
        ...
        public static final Rotation2d ANGLE_OFFSET = Rotation2d.fromDegrees(NTpreferences.getAngleOffset(Module.u3));
        public static final SwerveModuleConstants CONSTANTS = 
            new SwerveModuleConstants(DRIVE_MOTOR_ID, ANGLE_MOTOR_ID, CANCODER_ID, ANGLE_OFFSET);
    }
  }
