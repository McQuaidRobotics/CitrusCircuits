...
public class Autos {
    ...
    public static final Block[] TWO_GAME_PIECE_FLAT_NO_SWOOP = Blocks.groupBlocks(
        Cmds.OVERRIDE_HOLD_CONE,
        Cmds.PLACE_STANDBY,
        Cmds.PLACE_HIGH,
        PPPaths.PLACE9_FLAT.resetPose().merge(Cmds.STOW, Cmds.DESIRE_CUBE),
        PPPaths.FLAT_PICKUP4.merge(
                0.2, Cmds.PICKUP_GROUND, Cmds.OVERRIDE_HOLD_CUBE),
        PPPaths.PICKUP4_FLAT.merge(Cmds.STOW),
        PPPaths.FLAT_PLACE8.merge(Cmds.PLACE_STANDBY),
        Cmds.PLACE_HIGH,
        Cmds.HOME
    );
    ...
    public enum AutoRoutines {
        ...
        TWO_GAME_PIECE_FLAT_NO_SWOOP(Autos.TWO_GAME_PIECE_FLAT_NO_SWOOP),
